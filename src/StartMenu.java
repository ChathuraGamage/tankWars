...
public class StartMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMaximizedBounds(new java.awt.Rectangle(0, 0, 640, 480));
        setResizable(false);

        jLabel1.setFont(new java.awt.Font("Neverwinter", 0, 48));
        jLabel1.setText("Tank Wars");

        jLabel2.setFont(new java.awt.Font("Xerox Malfunction BRK", 0, 48));
        jLabel2.setText("by Wolfpack");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            TankServer sr=new TankServer(g);
